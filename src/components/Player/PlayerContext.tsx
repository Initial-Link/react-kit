...
export const PlayerContextProvider = (
  ...
  const syncAll = (time: number, playing: boolean, wasDeSync?: boolean) => {
    if (audioControlled) {
      ...
      if (wasDeSync) {
        console.log("performedDeSyncs", performedDeSyncs);
        performedDeSyncs++;
      }
      const attemptSync = () => {
        toSync--;
  ...
  return (
    <PlayerContext.Provider
      value={{
        targetControllerRef: targetControllerRef,
        refVideo,
        refAudio,
        ...
        actionOnTimeUpdate: (e, type) => {
          ...
          if (type === "video") {
            ...
            if (
              ...
              if (e.currentTarget.paused) refVideo.current.pause();
